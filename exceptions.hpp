...
S1B_MAKE_EINFO(metadata_uuid     , boost::uuids::uuid)
S1B_MAKE_EINFO(stored_uuid       , boost::uuids::uuid)
...
S1B_MAKE_DERIVED(uuid_mismatch        , format       )
S1B_MAKE_DERIVED(uuid_already_set     , format       )
